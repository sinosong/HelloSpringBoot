...
public enum AccrualExportEnum implements Serializable {
    ...
    AFRLNDTL_INTRATE(11, "正常利率", "INTRATE","STRING"),
    AFRLNDTL_RLVRATE(12, "展期利率", "RLVRATE","STRING"),
    AFRLNDTL_OVRRATE(13, "逾期利率", "OVRRATE","STRING"),
    AFRLNDTL_INCIRATE(14, "表内欠息复息利率", "INCIRATE","STRING"),
    AFRLNDTL_OFCIRATE(15, "表外欠息复息利率", "OFCIRATE","STRING"),
    AFRLNDTL_TAXRATE(16, "印花税率", "TAXRATE","STRING"),
    AFRLNDTL_CURRINT(17, "正常本金利息发生额", "CURRINT","STRING"),
    AFRLNDTL_RLVINT(18, "展期利息发生额", "RLVINT","STRING"),
    AFRLNDTL_RLVIBAL(19, "展期利息余额", "RLVIBAL","STRING"),
    AFRLNDTL_OVRAMT(20, "逾期本金发生额", "OVRAMT","STRING"),
    AFRLNDTL_OVRBAL(21, "逾期本金余额", "OVRBAL","STRING"),
    AFRLNDTL_OVRAMTIT(22, "逾期本金利息发生额", "OVRAMTIT","STRING"),
    AFRLNDTL_INAMT(23, "表内欠息发生额", "INAMT","STRING"),
    AFRLNDTL_INCURBAL(24, "表内欠息当前余额", "INCURBAL","STRING"),
    AFRLNDTL_INAMTIT(25, "表内欠息利息发生额", "INAMTIT","STRING"),
    AFRLNDTL_OFAMT(26, "表外欠息发生额", "OFAMT","STRING"),
    AFRLNDTL_OFCURBAL(27, "表外欠息当前余额", "OFCURBAL","STRING"),
    AFRLNDTL_OFAMTIT(28, "表外欠息利息发生额", "OFAMTIT","STRING"),
    AFRLNDTL_TAXSUM(29, "印花税", "TAXSUM","STRING"),
    AFRLNDTL_TAXAMT(30, "非豁免印花税发生额", "TAXAMT","STRING"),
    AFRLNDTL_TAXBAL(31, "非豁免印花税余额", "TAXBAL","STRING"),
    AFRLNDTL_NTAXAMT(32, "豁免印花税发生额", "NTAXAMT","STRING"),
    AFRLNDTL_NTAXBAL(33, "豁免印花税余额", "NTAXBAL","STRING"),
    AFRLNDTL_DRDOACTN(34, "放款帐号", "DRDOACTN","STRING"),
    AFRLNDTL_DRDOACSN(35, "放款帐号序号", "DRDOACSN","STRING"),
    AFRLNDTL_DRDOACTA(36, "放款帐号发生额", "DRDOACTA","STRING"),
    AFRLNDTL_PAYACTN(37, "还款账号", "PAYACTN","STRING"),
    AFRLNDTL_PAYACSN(38, "还款账号序号", "PAYACSN","STRING"),
    AFRLNDTL_PAYACTA(39, "还款账号发生额", "PAYACTA","STRING"),
    ...
    AFRCDTL_AMOUNT(70, "发生额", "AMOUNT","STRING"),
    AFRCDTL_UPDBAL(71, "更新后余额", "UPDBAL","STRING"),
    ...
    AFRCDTL_EXCHRAT(83, "货币兑换汇率", "EXCHRAT","STRING"),
    AFRCDTL_FORECURR(84, "外币币种", "FORECURR","STRING"),
    AFRCDTL_FOREAMT(85, "外币金额", "FOREAMT","STRING"),
