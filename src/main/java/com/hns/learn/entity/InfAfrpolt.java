 ...
 * @version 1.0
 */
@TableName("INF_AFRPOLT")
public class InfAfrpolt extends BaseModel implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InfAfrpolt)) return false;
        InfAfrpolt that = (InfAfrpolt) o;
